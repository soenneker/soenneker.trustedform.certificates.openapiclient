...
#nullable enable
        public async Task<global::Soenneker.TrustedForm.Certificates.OpenApiClient.Item.WithCert_PostResponse?> PostAsWithCert_PostResponseAsync(global::Soenneker.TrustedForm.Certificates.OpenApiClient.Item.WithCert_PostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.TrustedForm.Certificates.OpenApiClient.Item.WithCert_PostResponse> PostAsWithCert_PostResponseAsync(global::Soenneker.TrustedForm.Certificates.OpenApiClient.Item.WithCert_PostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        ...
        /// Introduction of TrustedForm Certificate API v4.0 <see href="https://community.activeprospect.com/posts/5066720-introducing-trustedform-certificate-api-v4-0" />
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.TrustedForm.Certificates.OpenApiClient.Item.WithCert_Response"/></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Soenneker.TrustedForm.Certificates.OpenApiClient.Models.BadRequest">When receiving a 400 status code</exception>
        ...
        /// <exception cref="global::Soenneker.TrustedForm.Certificates.OpenApiClient.Models.MethodNotAllowed">When receiving a 405 status code</exception>
        /// <exception cref="global::Soenneker.TrustedForm.Certificates.OpenApiClient.Models.UnprocessableEntity">When receiving a 422 status code</exception>
        [Obsolete("This method is obsolete. Use PostAsWithCert_PostResponseAsync instead.")]
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.TrustedForm.Certificates.OpenApiClient.Item.WithCert_Response?> PostAsync(global::Soenneker.TrustedForm.Certificates.OpenApiClient.Item.WithCert_PostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.TrustedForm.Certificates.OpenApiClient.Item.WithCert_Response> PostAsync(global::Soenneker.TrustedForm.Certificates.OpenApiClient.Item.WithCert_PostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.TrustedForm.Certificates.OpenApiClient.Item.WithCert_Response>(requestInfo, global::Soenneker.TrustedForm.Certificates.OpenApiClient.Item.WithCert_Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// The TrustedForm Certificate API is able to perform multiple operations based on the parameters sent in the request.Each operation is demonstrated in the request body documentation. The overall outcome of the operations is revealedby the `outcome` property. Best practice is to base your purchase decision on this property.Separate documentation about the parameters and results of each operation is available in the Operationsreference. and can be used alone or in tandem with another operation. The `match_lead` operation is requiredwhen running the `retain` operation.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class WithCert_ItemRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
