...
Instead, report it privately using this repository�s [GitHub private vulnerability reporting tool](https://github.com/soenneker/soenneker.trustedform.certificates.openapiclient/security/advisories/new).
